...
namespace UnityEditor.XR.Interaction.Toolkit
{
    ...
    public class XRInteractorLineVisualEditor : BaseInteractionEditor
    {
        ...
        protected static class Contents
        {
            ...
            public static readonly GUIContent stopLineAtFirstRaycastHit = EditorGUIUtility.TrTextContent("Stop Line At First Raycast Hit", "Controls whether the line will always be cut short by this behavior at the first raycast hit, even when invalid.");
        }
